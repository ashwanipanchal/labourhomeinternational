...
const RecruiterRagister = () => {
  ...
  const onProjectHandler = async () => {
    ...
    const response = await Api.reuritingAgentrRegister(body);
    ...
    <View style={{ backgroundColor: '#FFFFFF', flex: 1 }}>
      ...
      <KeyboardAwareScrollView>
        ...
        <View style={{ width: '100%', marginTop: 30 }}>
          <ButtonStyle title={'SUBMIT'} loader={state.isLoading} onPress={() => { onProjectHandler(); }} />
        </View>
        <BottomView />
...
export default RecruiterRagister;
